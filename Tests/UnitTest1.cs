    ...
    public class ProductQueryHandlerFixture
    {
        ...
        public void Setup()
        {
            ...
            products = new List<Product>
            {
                ...
                new Product { Id = 4, Amount = 6, Image = "https://i.ibb.co/KNFCs43/cosmetic-40.jpg", Price = 220, PriceFormatted = "220$", Title = "Fourth Product", CreatedAt = DateTime.Now  },
                new Product { Id = 5, Amount = 6, Image = "https://i.ibb.co/r6N7p8M/jar-03.jpg", Price = 220, PriceFormatted = "220$", Title = "Fifth Product", CreatedAt = DateTime.Now  },
                new Product { Id = 6, Amount = 6, Image = "https://i.ibb.co/X2gYjMN/jar-13.jpg", Price = 220, PriceFormatted = "220$", Title = "Sixth Product", CreatedAt = DateTime.Now  },
                new Product { Id = 7, Amount = 6, Image = "https://i.ibb.co/hcRbLBg/jar-24.jpg", Price = 220, PriceFormatted = "220$", Title = "Seventh Product", CreatedAt = DateTime.Now  },
                new Product { Id = 8, Amount = 6, Image = "https://i.ibb.co/mCMyJHD/jar-25.jpg", Price = 220, PriceFormatted = "220$", Title = "Eigth Product", CreatedAt = DateTime.Now  },
                new Product { Id = 9, Amount = 6, Image = "https://i.ibb.co/qJVPFxJ/jar-36.jpg", Price = 220, PriceFormatted = "220$", Title = "Nineth Product", CreatedAt = DateTime.Now  },
            };
        }
